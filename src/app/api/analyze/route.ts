...
22. 每题额外生成 practiceAnswer，作为 45-90 秒中文口播练习稿。它必须是一段可以直接照着说的完整回答，不要只写一句摘要；建议 180-300 个中文字符，至少包含“开头结论、背景/角色、关键动作、结果或反思”四个部分。它应基于 betterAnswer 但去掉证据颜色说明，不要使用 Markdown 或项目符号；缺少素材时用自然口语提示“这里我会补充真实数据/具体案例”，不要编造。
  ...
  "questions": [
    {
      ...
      "improvement": "改进思路",
      "betterAnswer": "更好回答范例",
      "practiceAnswer": "45-90 秒完整中文口播练习稿，180-300 个中文字符，包含结论、背景/角色、关键动作、结果或反思"
    }
  ],
  "predictions": [
    {
